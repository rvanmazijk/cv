...
% ![](logos/LinkedIn.png){ width=12 } [LinkedIn](https://www.linkedin.com/in/ruan-van-mazijk-4a04b0127)
% ![](logos/Mendeley-red.png){ width=12 } [Mendeley](https://www.mendeley.com/profiles/ruan-van-mazijk)
...
\begin{multicols}{2}
  \section*{Interests} % -------------------------------------------------------
    \par Systematics \& taxonomy
    \par Phylogenetic comparative methods
    \par Bodiversity patterns \& macroecology
    \par Community ecology
    \par Plant ecophysiology \& functional traits
  \section*{Professional affiliations} % ---------------------------------------
    \par SASSB\footnote{Southern African Society for Systematic Biology}
         council student representative
         \hfill 2019--2021
    \par SASSB student member
         \hfill 2018--
    \par SAAB\footnote{South African Association of Botanists}
         student member
         \hfill 2017--
    \par Golden Key International Honour Society
         \hfill 2015--
\end{multicols}
...
1\textsuperscript{st} oral presentation:            \hfill 9 January 2019 \break
...
Based on my then BSc Hons work, later published in \textit{Journal of 
  Biogeography}                                                           \break
2\textsuperscript{nd} oral presentation:           \hfill 11 January 2019 \break
