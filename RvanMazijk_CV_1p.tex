...
\textbf{MSc candidate} in Biological Sciences {\small (UCT) \\
  \hspace{2em} \textit{Genome-size effects on plant ecophysiology \& phenology in Cape schoenoid sedges} \\
  \hspace{2em} Principal supervisor: Prof A.M.~Muasya. Co-supervisors: Prof G.A.~Verboom \& Prof A.G.~West}
