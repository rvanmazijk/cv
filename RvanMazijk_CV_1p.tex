...
\textbf{Languages}     \hfill   English, Afrikaans, \textit{R}, \textit{bash} \\
\textbf{Tools    }     \hfill \textit{R} Markdown, {\fontfamily{lmr} \selectfont
                              \LaTeX}, \textit{git}, GitHub, MS Office

\textbf{Methods  }     \hfill       Statistical modelling, data manipulation, \\
                       \hfill     GIS (in \textit{R}), functional programming
