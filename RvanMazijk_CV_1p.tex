...
Student Sponsorship to attend MEDECOS XVII {\small
  (DST\footnote{Department of Science \& Technology
  (South Africa)}-NRF\footnote{National Research
  Foundation (South Africa)})}                     \hfill {\small       2022} \\
...
\hspace{2em} SAAB\footnote{South African
  ...
  African Society for Systematic Biology} IVXV
  (tie)                                            \hfill {\small       2019} \\
  AMA \& SASSB Joint Congress} (tie)               \hfill {\small       2019} \\
Innovation Masters Schol.       {\small (DST-NRF)} \hfill {\small       2019} \\
MSc Student Bursary             {\small    (SAAB)} \hfill {\small 2018--2019} \\
                                                      % (inaugural recipient)
Once-Off Award                  {\small     (UCT)} \hfill {\small       2018} \\
Travel grant for SAAB-AMA-SASSB IVXV
